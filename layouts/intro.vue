<template>
  <div class="intro-layout" :style="layoutStyle">
    <!-- 背景装饰 -->
    ...
    <div class="intro-container">
      ...
      <div class="intro-left">
        <div class="intro-content">
          ...
          <div
            class="intro-avatar"
            v-if="$frontmatter.avatar || $frontmatter.icon"
          >
            <img
            ...
            />
            <div
              v-else-if="$frontmatter.icon"
              class="avatar-icon"
              v-html="$frontmatter.icon"
            ></div>
          </div>

          <!-- 标题区域 -->
          <div class="intro-header">
            <h1 v-if="$frontmatter.title" class="intro-title">
              {{ $frontmatter.title }}
            </h1>
            <h2 v-if="$frontmatter.subtitle" class="intro-subtitle">
...
.intro-title {
  ...
  animation: fadeInUp var(--daocloud-animation-duration)
    var(--daocloud-animation-timing) 0.2s both;
}
...
.intro-subtitle {
  ...
  animation: fadeInUp var(--daocloud-animation-duration)
    var(--daocloud-animation-timing) 0.4s both;
}
...
.intro-tags {
  ...
  gap: 0.5rem;
  animation: fadeInUp var(--daocloud-animation-duration)
    var(--daocloud-animation-timing) 0.8s both;
}
...
.tag {
  ...
  transition: all var(--daocloud-transition-duration)
    var(--daocloud-transition-timing);
}
